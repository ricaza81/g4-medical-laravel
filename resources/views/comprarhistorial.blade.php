...
<body style="background:#000000;height: 1000px;/*#48484A*/">
    ...
    <div class="row">
        <div class="col col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
            <div class="ui-block" >
                    ...
                    <div class="ui-block-title inline-items">
                        <h1 class="title">Comprar nuevo historial personalizado</h1><h5 style="float:right;">variables meteorológicas<br>(límite: 5 años históricos)</h5>
                           ...
                           <div class="ui-block-title inline-items">
                             ...
                             <a style="font-size:25px;background: #76A82B;margin-top: 0px;margin-bottom: 60px;" class="btn btn-purple btn-lg" href="{{url('descargables/ConsultaFincaRisaraldaSept2020.pdf')}}" target="_blank">Esto obtienes (clic aquí)
                                                    </a>
                 ...
                 <div class="col-md-7" style="margin-top:-108px;padding:38px;background:#000000;margin-bottom: -25px;">
                   
                    <div class="ui-block" style="background-color:transparent;border: 0px solid #e6ecf5;">
                <!-- <div class="ui-block-content" style="background-color:transparent;">-->

                    <!--WebGL Globo-->                    
      <div id="container" style="height: 623px;margin-top: -34px;"></div>
                        <div id="info">
    <strong>
        <a href="http://www.chromeexperiments.com/globe">WebGL Globe</a></strong> <span class="bull">&bull;</span>  <span class="bull">&bull;</span>  <a href="http://sedac.ciesin.columbia.edu/gpw/"></a>
  </div>

 

  <a id="ce" href="consultaclima" target="_blank" style="height: 400px">
     <div id="currentInfo">
  ...
  <div id="title" style="border:0px">
    ...
    <span>Esto es un desarrollo Agronielsen.com</span>
  </a>
</div>
<!--WebGL Globo-->   
    ...
    <div class="row">
            <div class="col col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="ui-block">
                      ...
                      Ingresando las variables de Latitud y Longitud de una ubicación, obtendrás los datos climatologicos como <b style="color:#1565C0;font-weight: 600"><a href="{{url('descargables/ConsultaFincaRisaraldaSept2020.pdf')}}" target="_blank" style="color:#1565C0;font-weight: 600">Temperatura, Precipitación, Humedad relativa, Presión atmosferica, Velocidad del viento, UV index (luminosidad)</a></b>. 
                      <br><br>Puedes marcar la casilla "consultar mi ubicación" o arrastrar el marcador para una nueva ubicación. <br> <span><a href="https://agronielsen.com/descargables/ConsultaFincaRisaraldaSept2020.pdf" target="_blank">(Ver informe de ejemplo)</a></span>
                                    ...
                                    <input class="form-control" style="font-size:8px" type="hidden" placeholder="" id="url" name="url"/>
                                     ...
                                     <div class="col col-lg-6 col-md-6 col-sm-12 col-12" style="padding-bottom: 12px">
                                               <input id="checkbox-signup" class="form-control" type="checkbox" name="remember"/>
                                                <label for="checkbox-signup" style="margin-left: 20px;border-bottom: 2px solid #000;height: 35px;color: #000;"> Consultar mi ubicación actual
                                                </label>
                                    </div>
                                     <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="col-lg-3 col-md-7">
                        <div class="widget widget-menu">
                            ...
                            <ul class="footer-menu">
                                ...
                                <li><a href="https://www.facebook.com/agronielsen" target="_blank">Contacto</a></li>
...
<!--<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCJ05Rcuc-Ie0dfz0fDqdRiJJfE8d1rolw&callback=initMap" async defer></script>-->
