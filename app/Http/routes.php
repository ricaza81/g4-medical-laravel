...
/*----------------------/*DIRECTODEFINCA.COM-----------------------*/
Route::get('directofinca', 'Auth\AuthController@directofinca');
Route::get('tienda', 'Auth\AuthController@tienda');
Route::get('restaurantes', 'Auth\AuthController@restaurantes');
Route::get('detalleconsulta/{slug}', ['as' => 'detalleconsulta', 'uses' => 'UsuariosController@slugdetalleconsultashow']);
 Route::get('detalleempresaofertas/{slug}', ['as' => 'detalleempresaofertas', 'uses' => 'UsuariosController@slugdetalleempresaofertashow']);
 /*OfertaAgricultores(newsfeed)*/
 Route::get('detalledirectorio', 'DirectoProductorController@detalledirectorio');
/*SlugPublicacionesAgricultores(newsfeed)*/ 
 Route::get('detallepublicacion/{slug}', ['as' => 'producto', 'uses' => 'AgricultorController@slugpublicacionshow']);

 /*Solicitudesdelagricultor*/
 Route::get('missolicitudes', 'DirectoProductorController@missolicitudes');
  /*Solicitudesenviadasalagricultor*/
 Route::get('missolicitudesenviadas', 'DirectoProductorController@missolicitudesenviadas');
/*ContactodesdeNewsFeed*/
 Route::post('/contactardirecto', 'DirectoProductorController@contactardirecto');
 /*ContactoDirectoAgricultor*/
 Route::get('contactodirecto/{id}', 'DirectoProductorController@contactodirecto');
 /*GuardaNuevaSolicituddeContacto*/
 /*ContactodesdeNewsFeed*/
 Route::post('/agregar_solicitud_agricultor', 'DirectoProductorController@agregar_solicitud_agricultor');
  /*ConsultaClima*/
 Route::get('pronostclima', 'DirectoProductorController@pronostclima');
 /*ProductosRecomendados*/
 Route::get('recomendados', 'ProductosController@recomendados');
  /*ProductosRecomendados*/
 Route::post('/pagar', 'PagoController@pagar');

 /*----------------------/*CARRODECOMPRAS-----------------------*/
//Route::get('carro', 'ShopController@carro');/*->name('shop.index');
//Route::get('/shop/{product}', 'ShopController@show')->name('shop.show');
//Route::post('/cart/{product}', 'CartController@store')->name('cart.store');
//Route::post('nuevo_carro', 'CartController@nuevo_carro');
//Route::get('/cart', 'CartController@index')->name('cart.index');
//Route::get('/cart/{id}', 'CartController@cartito');
...
Route::group(['middleware' => 'auth'], function () {
  ...
  /*Route::get('storage/', function () {
    ...
    Route::get('/', 'HomeController@productoresoferta');
    Route::get('productoresoferta', 'HomeController@productoresoferta');
    Route::get('shop', 'HomeController@shop');
    Route::get('publicacionproducto', 'HomeController@publicacionproducto');
    /*NuevaPublicacion*/
    Route::post('agregarpublicaciondirectofinca', 'HomeController@agregarpublicaciondirectofinca');
    /*Productosdelagricultor*/
    Route::get('misproductos', 'HomeController@misproductos');
...
/*garantias*/
Route::get('form_nueva_garantia', 'AgricultorController@form_nueva_garantia');
Route::post('agregar_nueva_garantia', 'AgricultorController@agregar_nueva_garantia');
Route::get('garantia', 'AgricultorController@garantia');
/*garantias*/
